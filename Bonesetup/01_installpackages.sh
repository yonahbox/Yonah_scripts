...
sudo apt-get update
sudo apt-get install ros-kinetic-ros-base python-rosdep
sudo rosdep init
rosdep update
...
sudo apt-get install ros-kinetic-mavros ros-kinetic-mavros-extras python-catkin-tools
wget https://raw.githubusercontent.com/mavlink/mavros/master/mavros/scripts/install_geographiclib_datasets.sh
chmod a+x install_geographiclib_datasets.sh
bash install_geographiclib_datasets.sh

# Step 5: Install remaining packages.
# Some are to make ROS Kinetic compatible with Python3. Others are dependencies for our software
# See https://medium.com/@beta_b0t/how-to-setup-ros-with-python-3-44a69ca36674
sudo apt-get install python3-pip python3-yaml htop git tmux nmap screen python3-paramiko
pip3 install --user rospkg catkin_pkg defusedxml netifaces pyserial

# Step 6: Configure timezone to Singapore time
